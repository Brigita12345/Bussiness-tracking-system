...
INSERT INTO `orders` (`order_id`, `product_id`, `quantity`, `quality`, `buying_price`, `transport_fee`, `total_cost`, `order_date`) VALUES
(1, 1, 20, '', 200.00, 300.00, 4300.00, '2025-08-31 06:39:20');
...
INSERT INTO `users` (`id`, `fullname`, `email`, `password`, `gender`, `role`, `profile_pic`, `date`) VALUES
(1, 'beaty ', 'beaty@gmail.com', '$2y$10$2DrU.JRLzIR3hV0XiDhtZuejT7dsrQCayrx2Jyajw3xM4h4/m0gB2', 'Female', 'admin', 'uploads/profile_1_1756617944.jpg', '2025-08-29 10:55:06');
...
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`),
